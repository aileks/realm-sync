...
Phase 5 focuses on refining the user experience, fully integrating the **Vellum** mascot, and adding quality-of-life features that elevate Realm Sync from a functional tool to a polished product. This phase also lays the groundwork for advanced post-MVP features.

**Goal:** Refine UX, fully integrate Vellum mascot, and add quality-of-life features. **Duration:** Ongoing **Dependencies:** Phases 1-4 complete (core functionality working)
...
## 2. Vellum Mascot Integration

Vellum is the soul of the archive — a helpful, slightly formal, yet warm moth archivist.
...
All system feedback is delivered in Vellum's voice.
...
1. **Welcome:** Modal with Vellum introduction and a brief explanation of "Canon Tracking."
...
6. **Continuity Explanation:** Briefly show how Vellum catches contradictions.

### Components

- `OnboardingModal`: Multi-step container.
- `FeatureTooltip`: Contextual "Vellum hints" pointing to UI elements.
...
- UI for tracking "Questions Vellum has" about the world.
...
- **Mascot Interaction:** Ensure Vellum's animations don't interfere with core UI interaction.
...
- Record a short "Vellum Walkthrough" demo video.
